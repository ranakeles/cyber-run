...
/* SORU HAVUZU — çocuklar için (106 soru: 52 güvenli, 54 şüpheli).
   ...
   Cevap hiçbir soruda göndericinin adresine ya da bağlantının kendisine
   bağlı DEĞİL; çocuk mesajın ne istediğine bakarak karar verebilmeli.
   Bu yüzden kartta e-posta adresi hiç gösterilmiyor, sadece kimden
   geldiği ("Annem", "Öğretmenim") yazıyor.
...
const POOL = [
  /* ===== GÜVENLİ ===== */
  // kolay
  {from:"Öğretmenim", subj:"Yarınki Resim Dersi",
  ...
  {from:"Uzay Macerası", subj:"Yeni Bölüm Geldi!",
  ...
  {from:"Bilim Merkezi", subj:"Hafta Sonu Atölyeleri",
  ...
  {from:"Uzay Macerası", subj:"Tebrikler!",
  ...
  {from:"Arkadaşın Elif", subj:"Parkta Oynayalım mı?",
  ...
  {from:"Teyzem", subj:"Tatil Fotoğrafları",
  ...
  {from:"Tabletim", subj:"Mola Zamanı",
  ...
  {from:"Rehber Öğretmen", subj:"Her Zaman Buradayım",
  ...
  {from:"Hesap Bildirimi", subj:"Yeni Giriş",
  ...
  {from:"Annem (yeni numara)", subj:"Yeni Numaram",
  ...
  {from:"Okulum", subj:"Resim Yarışması",
  ...
  {from:"Yeni Arkadaş", subj:"Buluşalım mı?",
  ...
  {from:"Ünlü Oyuncu", subj:"Seviyeni Yükselteyim",
   text:"Hesabını bana ver, seviyeni ben yükselteyim.", safe:false,
   why:"Oyun hesabını kimseye verme."},
  {from:"Telefon Hızlandır", subj:"10 Kat Hızlı Telefon!",
  ...
  {from:"Telefon Temizleyici", subj:"5 Virüs Bulundu!",
  ...
  {from:"Hile Programı", subj:"Sınırsız Elmas!",
  ...
  {from:"Gizli Oyun", subj:"Sadece Çocuklar İçin",
  ...
  {from:"Arkadaşın Can", subj:"Sen de Varsın!",
  ...
  {from:"Uzay Macerası", subj:"Hesabını Koru",
  ...
  {from:"Kütüphane", subj:"İade Süren Doldu!",
